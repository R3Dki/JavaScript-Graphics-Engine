...
//Cube
//3D Vertexes
let Vertex1 = new Vertex(300, 200, 80); //top left
let Vertex2 = new Vertex(500, 200, 80); //top right
let Vertex3 = new Vertex(500, 400, 80); //bottom right
let Vertex4 = new Vertex(300, 400, 80); //bottom left
let Vertex5 = new Vertex(300, 200, 90); //top left behind
let Vertex6 = new Vertex(500, 200, 90); //top right behind
let Vertex7 = new Vertex(500, 400, 90); //bottom right behind
let Vertex8 = new Vertex(300, 400, 90); //bottom left behind
//Projection
...
Triangle(Vertex5.x, Vertex5.y, Vertex6.x, Vertex6.y, Vertex7.x, Vertex7.y);
...
Triangle(Vertex8.x, Vertex8.y, Vertex7.x, Vertex7.y, Vertex4.x, Vertex4.y);
Triangle(Vertex7.x, Vertex7.y, Vertex2.x, Vertex2.y, Vertex3.x, Vertex3.y);
//Cube
